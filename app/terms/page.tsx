...
// Route: /terms (Terms and Conditions page)
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <article className={styles.content}>
        ...
        <p className={styles.updated}>Last updated: February 06, 2026</p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Mr OTP LLC,
            ...
            <li>
              <p>
                ...
                agreement between You and the Company regarding the Service. These Terms and
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Mr OTP, accessible from{' '}
                <a href="https://mr-otp.com/" rel="external nofollow noopener" target="_blank">
                  https://mr-otp.com/
                </a>
              </p>
            </li>
        ...
        <section className={styles.section}>
          ...
          <p>
            The Service may display, include, make available, or link to content or services
            provided by a Third-Party Social Media Service. A Third-Party Social Media Service is
            not owned or controlled by the Company, and the Company does not endorse or assume
            responsibility for any Third-Party Social Media Service.
          </p>
          <p>
            ...
            connection with Your access to or use of any Third-Party Social Media Service, including
            any content, goods, or services made available through them. Your use of any Third-Party
            Social Media Service is governed by that Third-Party Social Media Service&apos;s terms
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            an obligation under these Terms shall not affect a party&apos;s ability to exercise
            such right or require such performance at any time thereafter nor shall the waiver of a
