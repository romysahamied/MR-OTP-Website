      ...
      <article className={styles.content}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                50% or more of the shares, equity interest or other securities entitled to vote for
            ...
            <li>
              <p>
                ...
                &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Mr OTP LLC, Shams
                Business Center, Sharjah Media City, Sharjah, United Arab Emirates.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                information that relates to an identified or identifiable individual. We use
                &quot;Personal Data&quot; and &quot;Personal Information&quot; interchangeably
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            and remarketing cookies) only with Your consent. You can withdraw or change Your
            consent at any time using Our cookie preferences tool (if available) or through Your
            browser/device settings. Withdrawing consent does not affect the lawfulness of
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                that you have already purchased or inquired about unless You have opted not to
            ...
            <li>
              <p>
                <strong>For business transfers:</strong> We may use Your Personal Data to evaluate
          ...
          <ul>
            <li>
              <strong>With Service Providers:</strong> We may share Your Personal Data with
              Service Providers to monitor and analyze the use of our Service, to contact You.
            </li>
            <li>
              <strong>For business transfers:</strong> We may share or transfer Your Personal Data
            ...
            <li>
              <strong>With other users:</strong> If Our Service offers public areas, when You share
              Personal Data or otherwise interact in the public areas with other users, such
              information may be viewed by all users and may be publicly distributed outside.
            </li>
            <li>
              <strong>With Your consent:</strong> We may disclose Your Personal Data for any
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  Support tickets and correspondence: up to 24 months from the date of ticket
                  closure to resolve follow-up inquiries, track service quality, and defend against
            ...
            <li>
              ...
              <ul>
                <li>
                  Website analytics data (cookies, IP addresses, device identifiers): up to 24
          ...
          <p>
            Usage Data is retained in accordance with the retention periods described above, and
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            We strive to use commercially reasonable means to protect Your Personal Data, We
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            anyone under the age of 16 without verification of parental consent, We take steps to
